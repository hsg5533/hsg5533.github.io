        ...
        <table className="profile-table">
          ...
          <tbody>
            ...
            <tr className="profile-row">
              ...
              <th>병역</th>
              <td className="center bold">필_육군(통신병: 2017.04~2018.12)</td>
            </tr>
            <tr className="profile-row">
              <th>이메일</th>
              <td className="center bold">hsg5533@naver.com</td>
              <th>핸드폰</th>
              <td className="center bold">010-8069-6766</td>
            </tr>
            <tr className="profile-row">
              <th>주소</th>
            ...
            <tr>
              ...
              <td className="center bold">(재)부산인재개발원 부산IT교육센터</td>
            </tr>
            <tr>
              <th>주요내용</th>
            ...
            <tr>
              <th>담당역할</th>
              <td colSpan={4} className="center bold">
                스프링 프레임워크를 통한 회원가입, 로그인, 게시판 기능, 댓글 및
                이미지 파일 업로드 기능 구현
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>담당역할</th>
              <td colSpan={4} className="center bold">
                Firebase의 실시간 데이터베이스를 통한 회원가입과 로그인 기능 및
                게시판 기능, 사진 업로드 기능 구현
              </td>
            </tr>
            <tr>
      ...
      <section className="page">
          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                부담이 있는 프로젝트 상황에서도 쉽게 지치지 않고, 항상 긍정적인
                태도로 임할 수 있습니다. 또한, 스트레스 상황에서도 냉정하게
                상황을 파악하고 판단하는 능력을 바탕으로 현실적인 문제 해결에
                집중할 수 있습니다. 실무 개발자로 근무하며 소통과 팀워크의
                중요성을 깊이 체감했습니다. 여러 프로젝트를 동시에 수행하며 업무
                우선순위를 설정하고, 팀원들의 진행 상황을 함께 고려하며 유연하게
                협업하는 방식은 효율성과 만족도를 동시에 높여주었습니다. 특히,
                동료 간의 갈등이 생길 때 먼저 다가가 문제를 풀고 팀워크를
                회복시키는 데 주저함이 없었습니다. 앞으로도 현업 개발자들과의
                소통과 코드 리뷰, 기술 공유를 통해 꾸준히 실력을 다져나가고자
                합니다. 저는 단순히 기술적인 역량만 뛰어난 개발자가 아닌, 팀과
                함께 성장하며 협업의 가치를 실현할 수 있는 개발자가 되고자
                합니다. 동료와 함께 문제를 해결하고, 함께 배워 목표를 달성하는
                과정에서 큰 성취감을 느낍니다. 앞으로도 공동의 목표를 향해
                기꺼이 헌신하고, 팀에 긍정적인 영향을 줄 수 있는 구성원이
                되겠습니다.
              </td>
            </tr>
          </tbody>
        ...
        <table className="essay-table">
          <tbody>
            ...
            <tr>
              <td>
                소프트웨어 산업은 빠른 기술 변화 속에서도, 사용자 경험을 깊이
                이해하고 이를 실제 서비스로 구현해내는 역량을 갖춘 개발자가
                꾸준히 성장할 수 있다고 생각합니다. 저는 스프링 기반의 웹
                서비스와 Firebase 연동 안드로이드 앱 개발을 시작으로, 실무에서는
                React Native 하이브리드 앱의 개발과 배포, 그리고 자사 홈페이지
                유지보수까지 웹과 앱을 아우르는 다양한 프로젝트를 경험하며
                요구사항 분석부터 설계, 구현, 배포에 이르는 개발 사이클 전반을
                체계적으로 수행하는 능력을 길렀습니다. 이러한 경험을 바탕으로
                프론트엔드와 백엔드를 넘나들며 문제를 해결하고, 사용자 중심의
                가치를 실현할 수 있는 개발자로 성장하고자 지원하게 되었습니다.
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                개선 방향과 사용자와의 커뮤니케이션 역량을 강화할 수 있었습니다.
                이제는 이러한 경험을 바탕으로 문제 해결과 지속적인 혁신을
                추구하는 개발자가 되고자 합니다. 현재는 웹 기반 프론트엔드
                개발과 백엔드 시스템 연동, 데이터 시각화 구축 등에 관심을 갖고
                역량을 키워나가고 있습니다.
              </td>
            </tr>
          </tbody>
        ...
        <table className="essay-table">
          <tbody>
            ...
            <tr>
              <td>
                기술은 빠르게 변화하지만, 사용자의 니즈와 고객 만족이라는 본질은
                변하지 않습니다. 입사 후에는 소프트웨어 개발자로서 기업의 고객
                중심 가치를 실현할 수 있도록 끊임없이 배우고 성장해
                나가겠습니다. 특히 제품 개발을 위한 요구사항 분석, 서비스 설계,
                품질 개선 등 전 과정에서 프로세스를 빠르게 이해하고 기술적으로
                기여할 수 있는 역량을 갖추겠습니다. 또한 스스로를 낮추고 동료를
                존중하며, 열린 자세로 협업에 임할 것입니다. 문제를 단순히
                해결하는 데 그치지 않고, 고객과 기업의 가치를 함께 높일 수 있는
                차별화된 솔루션을 고민하며, 시장의 변화 속에서도 유연하고
                주도적인 개발자로 성장해 나가겠습니다.
              </td>
            </tr>
          </tbody>
        </table>
